---
url: https://www.nbg.gr/el/go4more/programma-pws-leitourgei/pws-sullegw-pontous-go4more
title: Πώς κερδίζω Go For More πόντους | Εθνική Τράπεζα
description: Ανακαλύψτε πως κερδίζετε Go For More πόντους στα πλαίσια του προγράμματος επιβράβευσης Go For More. Μάθετε περισσότερα στο site!
scraped_at: 2025-05-31T19:55:56.492064
status_code: 200
---

# Πώς κερδίζω Go For More πόντους | Εθνική Τράπεζα
...
## Κερδίζετε πόντους, κερδίζετε ευρώ 

Επιβραβεύεστε καθημερινά για όσα μέχρι σήμερα δεν μετρούσαν.

Συγκεκριμένα, όταν:

Προσκαλείτε έναν φίλο στο πρόγραμμα.

Αποκτάτε ένα καταθετικό πακέτο.

Κάνετε αγορές στις συνεργαζόμενες επιχειρήσεις με τη χρεωστική ή την προπληρωμένη σας κάρτα.

Κάνετε οποιαδήποτε αγορά με την πιστωτική σας κάρτα.

Κάνετε μία επένδυση.

Πραγματοποιείτε συναλλαγές μέσω Digital Banking.

Πληρώνετε μια δόση του δανείου σας.

Αποκτάτε ασφάλιση για το όχημά σας.
...
- **URL**: https://www.nbg.gr/el/go4more/programma-pws-leitourgei/pws-sullegw-pontous-go4more
- **Scraped At**: 2025-05-31T19:55:56.492064
- **Links Found**: 94
- **Images Found**: 6
