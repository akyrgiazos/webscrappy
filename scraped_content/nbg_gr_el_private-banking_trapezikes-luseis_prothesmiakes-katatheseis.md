---
url: https://www.nbg.gr/el/private-banking/trapezikes-luseis/prothesmiakes-katatheseis
title: Private Banking - Προθεσμιακές Καταθέσεις | Εθνική Τράπεζα
description: Μάθετε για τις επιλογές σε προθεσμιακές καταθέσεις που σας προσφέρει η υπηρεσία private banking. Μπείτε στο site της Εθνικής Τράπεζας για περισσότερα!
scraped_at: 2025-05-31T19:59:17.249148
status_code: 200
---

# Private Banking - Προθεσμιακές Καταθέσεις | Εθνική Τράπεζα
...
# 
  ...
  * Private Banking - Προθεσμιακές Καταθέσεις 
...
Μπορείτε να αυξήσετε ή να μειώσετε το ύψος των ρευστών διαθεσίμων του χαρτοφυλακίου σας μέσω των προθεσμιακών καταθέσεων προκειμένου να ελέγξετε το βαθμό κινδύνου.

### Εύκολες συναλλαγές

Μπορείτε να κάνετε απλές και γρήγορες συναλλαγές μέσω του Internet Banking ή να εξυπηρετηθείτε από το προσωπικό σας στέλεχος εξυπηρέτησης.

### Γρήγορες εναλλαγές

Μπορείτε να κάνετε γρήγορες και εύκολες εναλλαγές μεταξύ επενδυτικών προϊόντων και καταθέσεων με τη βοήθεια του προσωπικού σας στελέχους εξυπηρέτησης.
...
- **URL**: https://www.nbg.gr/el/private-banking/trapezikes-luseis/prothesmiakes-katatheseis
- **Scraped At**: 2025-05-31T19:59:17.249148
- **Links Found**: 88
- **Images Found**: 9
