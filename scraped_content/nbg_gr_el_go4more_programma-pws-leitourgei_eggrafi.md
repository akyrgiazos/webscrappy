---
url: https://www.nbg.gr/el/go4more/programma-pws-leitourgei/eggrafi
title: Go For More Εγγραφή | Εθνική Τράπεζα
description: Μάθετε πως μπορείτε να κάνετε την εγγραφή σας στο πρόγραμμα επιβράβευσης Go For More εύκολα και γρήγορα. Δείτε περισσότερα στο site!
scraped_at: 2025-05-31T19:55:52.642436
status_code: 200
---

# Go For More Εγγραφή | Εθνική Τράπεζα
...
## Πώς συμμετέχετε στο Go For More

Εάν είστε κάτοχος ενεργής κάρτας της Εθνικής, μπορείτε να εγγραφείτε στο πρόγραμμα και να μπείτε στον κόσμο της επιβράβευσης του Go For More. Η εγγραφή σας μπορεί να πραγματοποιηθεί δωρεάν με έναν από τους παρακάτω τρόπους:

Κάντε εγγραφή [εδώ](/el/go4more/forma-eggrafis-go4more)

Μέσω του τηλεφωνικού κέντρου στο 210 4848484

Στο **Go For More** app

Μέσω Digital Banking
...
- **URL**: https://www.nbg.gr/el/go4more/programma-pws-leitourgei/eggrafi
- **Scraped At**: 2025-05-31T19:55:52.642436
- **Links Found**: 94
- **Images Found**: 6
